...
awk '$4 ~ /^N+$/ && $5 ~ /^N+$/' masked_variants.vcf >> scenario_1.txt
...
awk '$4 ~ /^[ACTG]+$/ && $5 ~/^\.$/' masked_variants.vcf >> scenario_2.txt
...
awk '$4 ~ /^[ACTG]+$/ && $5 ~ /^\.$/' masked_variants.vcf >> scenario_5.txt
...
awk '$4 ~ /^N+$/ && $5 ~ /^[ACTG]+$/' masked_variants.vcf >> scenario_6.txt
